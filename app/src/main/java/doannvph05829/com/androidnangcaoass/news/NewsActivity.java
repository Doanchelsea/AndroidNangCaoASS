package doannvph05829.com.androidnangcaoass.news;
...
public class NewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Adapter adapter=new Adapter(this,R.layout.item_list,dsbaiviet);
        ...
        Thread thread=new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    URL url=new URL("http://vietnamnet.vn/rss/home.rss");
